...
def compute_train_metrics(batch: DataProto) -> Dict[str, Any]:
    reward = batch.non_tensor_batch["score"]
    acc = batch.non_tensor_batch["acc"]
    acc_reward = batch.non_tensor_batch["acc_reward"]
    format_reward = batch.non_tensor_batch["format_reward"]
    metrics = {
        # reward/score
        "train_metrics/score/mean": sum(reward)/len(reward),
        "train_metrics/score/max": max(reward),
        "train_metrics/score/min": min(reward),
        # acc
        "train_metrics/acc/mean": sum(acc)/len(acc),
        "train_metrics/acc/max": max(acc),
        "train_metrics/acc/min": min(acc),
        # acc_reward
        "train_metrics/acc_reward/mean": sum(acc_reward)/len(acc_reward),
        "train_metrics/acc_reward/max": max(acc_reward),
        "train_metrics/acc_reward/min": min(acc_reward),
        # format_reward
        "train_metrics/format_reward/mean": sum(format_reward)/len(format_reward),
        "train_metrics/format_reward/max": max(format_reward),
        "train_metrics/format_reward/min": min(format_reward),
    }
    return metrics
